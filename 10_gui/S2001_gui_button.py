...
main_window.title('Test GUI')  # text shown in the top window bar
...
button_1 = tk.Button(main_window, text="Click me, I am a button", activebackground="red", activeforeground="green")
